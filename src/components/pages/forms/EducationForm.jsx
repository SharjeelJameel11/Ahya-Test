...
function EducationForm({ data, addItem, removeItem, updateItem, isEdit, onNext }) {
  ...
  const educationData = data.length
    ? data
    : [{
        levelofeducation: "",
        fieldofstudy: "",
      ...
      const isNextDisabled = educationData.some(edu => 
        !edu.levelofeducation || !edu.fieldofstudy || !edu.university || !edu.passingyear
      );
  return (
        ...
        <div key={index}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <FormInput
              ...
              onChange={(val) => updateItem(index, "levelofeducation", val)}
            ...
            <FormInput
              ...
              onChange={(val) => updateItem(index, "fieldofstudy", val)}
            ...
            <FormInput
              ...
              onChange={(val) => updateItem(index, "passingyear", val)}
